...
# свойства товара не должны оставаться пустыми
  ...
  test "product price must be positive" do
	...
	product = Product.new(title: "aaaa", description: "yyy", image_url: "zzz.jpg")
	product.price = -1
	assert product.invalid?
  ...
  def new_product(image_url)
	Product.new(title: "aaaaa", description: "yyy", price: 1, image_url: image_url)
  end
	...
	test "product is not valid without a unique title" do
		...
		product = Product.new(title: products(:playground).title, description: "yyy", price: 1, image_url: "fred.gif")
